...
<body background= "../111.png">
    ...
    <div class="pdc">
        <form action='adr_add.php' method='post' onsubmit='return edit1()' style="display: flex; flex-direction: column; font-family: Poppins; font-weight: 600;">
        ...
        <script>
            ...
            <?php
                ...
                $stmt->bind_param("isiss", $id, $adre, $zip, $city, $st);
                $stmt->execute();
            ?>
            }
