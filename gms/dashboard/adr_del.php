...
<body background= "../111.png">
    ...
    <div class="pdc">
        <form action='adr_del.php' method='post' onsubmit='return edit1()' style="display: flex; flex-direction: column; font-family: Poppins; font-weight: 600;">
