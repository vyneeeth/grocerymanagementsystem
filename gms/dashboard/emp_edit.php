...
<body background= "../111.png">
    ...
    <div class="pdc">
        <form action='emp_edit.php' method='post' onsubmit='return edit1()' style="display: flex; flex-direction: column; font-family: Poppins; font-weight: 600;">
        ...
        <script>
            ...
            <?php
                ...
                $sal = $_POST['sal'];
                $id = $_POST['id'];
                $sql = "UPDATE employees SET employeename=?, shift=?, salary=? WHERE employeeid=?";
                $stmt= $conn->prepare($sql);
                $stmt->bind_param("ssii", $name, $shift, $sal, $id);
                $stmt->execute();
            ?>
            }
